...
var NgGridItem = NgGridItem_1 = (function () {
    //	Constructor
    function NgGridItem(_differs, _ngEl, _renderer, _ngGrid, containerRef) {
        ...
        this._size = { x: 1, y: 1 };
        this._config = NgGridItem_1.CONST_DEFAULT_CONFIG;
        this._added = false;
        this._maxCols = 0;
        this._minCols = 0;
        this._maxRows = 0;
    ...
    Object.defineProperty(NgGridItem.prototype, "config", {
        ...
        set: function (v) {
            var defaults = NgGridItem_1.CONST_DEFAULT_CONFIG;
            for (var x_1 in defaults)
                if (v[x_1] == null)
                    v[x_1] = defaults[x_1];
            this.setConfig(v);
    ...
    NgGridItem.prototype.setConfig = function (config) {
        ...
        this._position.col = this._currentPosition.col = config.col ? config.col : NgGridItem_1.CONST_DEFAULT_CONFIG.col;
        this._position.row = this._currentPosition.row = config.row ? config.row : NgGridItem_1.CONST_DEFAULT_CONFIG.row;
        this._size.x = config.sizex ? config.sizex : NgGridItem_1.CONST_DEFAULT_CONFIG.sizex;
        this._size.y = config.sizey ? config.sizey : NgGridItem_1.CONST_DEFAULT_CONFIG.sizey;
...
NgGridItem = NgGridItem_1 = __decorate([
    core_1.Directive({
        selector: '[ngGridItem]',
